...
const form = ref({ nombre: '', apellido: '', email: '', password: '', confirmar: '', telefono: '' })
const error = ref('')
...
<template>
  <div class="auth-wrapper">
    <div class="auth-card">
      ...
      <p class="auth-subtitle">Únete a Evobike Elite y disfruta de una experiencia personalizada</p>

      <form @submit.prevent="handleRegistro" class="auth-form">
        <div class="form-row">
          <div class="form-group">
            <label for="nombre">Nombre</label>
            <input id="nombre" v-model="form.nombre" type="text" placeholder="Tu nombre" required />
          </div>
          <div class="form-group">
            <label for="apellido">Apellido</label>
            <input id="apellido" v-model="form.apellido" type="text" placeholder="Tu apellido" />
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <input id="telefono" v-model="form.telefono" type="tel" placeholder="10 dígitos" />
        </div>
        ...
        <div class="form-row">
          ...
          <div class="form-group">
            ...
            <input id="confirmar" v-model="form.confirmar" type="password" placeholder="Repite tu contraseña" required />
          </div>
        </div>
